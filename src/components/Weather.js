    ...
    render() {
        return (
            <div className="weather__info">
                {/* if the city, country, temperature, humidity & description exists; then return them and display them */}
                {
                ...
                {
                    this.props.description && <p className="weather__key"> Weather Conditions:
